...
describe('TripCard', () => {
  const mockTrip: Trip = {
    ...
    duration: '10 days',
    items: [
      { id: 'i1', name: 'Passport', category: CATEGORIES[0], isPacked: true },
  ...
  it('renders trip name correctly', () => {
    render(<TripCard trip={mockTrip} onSelectTrip={() => {}} onDelete={() => {}} />);
  ...
  it('calls onSelectTrip when clicked', () => {
    ...
    render(<TripCard trip={mockTrip} onSelectTrip={onSelectTripMock} onDelete={() => {}} />);
